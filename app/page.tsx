    ...
    Contenu gratuit
      ...
      <section className="px-5 pb-24">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-5">
          ...
          {/* PODCAST */}
          <a id="podcast" href="https://youtu.be/KoKkuErzN9c" className="group bg-[#141416] border border-white/10 rounded-3xl p-8 hover:border-[#D4A853]/60 transition flex flex-col">
