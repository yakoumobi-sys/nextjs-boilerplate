        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-xl text-white/60 mb-8">
              De l'idee au lancement. Pas besoin de savoir coder.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  "Generer des idees SaaS rentables",
                  "Utiliser l'IA pour developper (Claude, Cursor)",
                  "Build sans code (No-code tools)",
                  "Lancer ton MVP en 2 semaines",
                  "Trouver tes premiers clients",
                  "Monetiser et faire $10K/mois",
                ].map((item) => (
              ...
              <div className="mt-10 p-6 bg-[#141416] border border-white/10 rounded-2xl">
                ...
                <p className="text-white/50">Fondateur InvoiceDZ</p>
